...
from investigatinator.enrichment.dns import dns_lookup
...
from investigatinator.enrichment.rdap import rdap_lookup
from investigatinator.enrichment.securitytrails import securitytrails_domain_lookup
from investigatinator.enrichment.virustotal import virustotal_domain_report
from investigatinator.enrichment.whois import whois_lookup
...
def domain_reputation(domain: str) -> dict[str, Any]:
    ...
    for provider_name, provider_function in PROVIDERS:
        result = provider_function(normalized_domain)
...
def _confidence(
    ...
    if verdict == "unknown":
        return "low" if success_count < 4 else "medium"
