...
from investigatinator.config import get_research_user_agent, get_timeout_seconds
from investigatinator.enrichment.models import (
    InputValidationError,
    error_response,
    success_response,
)
from investigatinator.research.iocs import extract_iocs
...
def _fetch_article(url: str) -> Article:
    ...
    return _parse_article(normalized_url, response.text)
